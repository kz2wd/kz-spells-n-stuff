...
object PlayerAttributesDeclaration {
    ...
    fun declare(plugin: JavaPlugin, session: Session) {
        ...
        val allAttributes = listOf(
            pickaxeAttribute, miningSpeedAttribute, healthAttribute,
        ...
        val xpCmd = object : SubCommand(xpCommandName) {
            override fun onCommand(
                ...
                SkillMenu(session, attributesMaterials.zip(allAttributes)).open(sender)
                return true
            }
...
//        val xpCmd = IntrinsicManagerMenu(session)
        ...
        val xpCommandsExecutor = MainCommandExecutor(xpCommands)
