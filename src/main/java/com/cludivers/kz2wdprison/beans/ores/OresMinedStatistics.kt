...
class OresMinedStatistics {
    ...
    var stone = OreStats(Ores.STONE.minXp + 1)
    ...
    var coal = OreStats(Ores.COAL.minXp + 1)
    ...
    var iron = OreStats(Ores.IRON.minXp + 1)
    ...
    var gold = OreStats(Ores.GOLD.minXp + 1)
    ...
    var diamond = OreStats(Ores.DIAMOND.minXp + 1)
    ...
    var redstone = OreStats(Ores.REDSTONE.minXp + 1)
