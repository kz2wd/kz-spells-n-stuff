...
class OresMinedStatistics {
    ...
    var stone = OreStats(Ores.STONE.minXp * 1.5f)
    ...
    var coal = OreStats(Ores.COAL.minXp * 1.5f)
    ...
    var iron = OreStats(Ores.IRON.minXp * 1.5f)
    ...
    var gold = OreStats(Ores.GOLD.minXp * 1.5f)
    ...
    var diamond = OreStats(Ores.DIAMOND.minXp * 1.5f)
    ...
    var redstone = OreStats(Ores.REDSTONE.minXp * 1.5f)
